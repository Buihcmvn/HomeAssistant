...
"""
	...
	Created on Wed Sep 29 08:57:36 2022
        ...
        ********** in this code run the  threading distanz not stabil
...
def distanz(queue, event):
  ...
  while queue.get()!="sensor Stop":
    ...
    abstand = "abstand" + str(dis)

    # put abstand in daten pipeline
    logging.info("put abstand: " + str(dis))
    pipeline.put(abstand) # für den fall distance messen als thread und ganzen zeit laufen




# function for sensor untrasonic
# =====================================================================
def distanz_():
